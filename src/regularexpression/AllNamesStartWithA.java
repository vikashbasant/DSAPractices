...
public class AllNamesStartWithA {
    public static void main(String[] args) {
        ...
        if (m.find() && (m.group().equals(targetString))) {
            System.out.println("Yes, Name " + targetString + " start with 'a||A'");
        } else {
            System.out.println("No, Name " + targetString + " not start with 'a||A'");
        }
